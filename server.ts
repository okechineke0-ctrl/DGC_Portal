...
async function startServer() {
  ...
  app.get('/api/health', (req, res) => {
    res.json({
      ...
      school: 'Dominion Star Global College',
  ...
  app.post('/api/staff/verify', (req, res) => {
    ...
    return res.json({
      matched: false,
      message: 'Name does not match any registered Dominion Star Global College staff member.',
    });
  });
  ...
  app.post('/api/students', async (req, res) => {
    try {
      ...
      const newStudent: StudentProfile = {
        ...
        formTeacherComment: 'A newly enrolled scholar at Dominion Star Global College. Ready to pursue academic excellence.',
        principalComment: 'Welcome to Dominion Star Global College. Maintain steadfast discipline and strive for high moral standards.',

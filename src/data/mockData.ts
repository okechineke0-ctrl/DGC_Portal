...
export const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    date: '14 Sept 2026',
    urgent: true,
    content: 'All faculty members are reminded that Quiz, Homework, and Tests (1 & 2) entries are now live on the Staff portal. Ensure scores are synchronized with the central examination broadsheet.',
